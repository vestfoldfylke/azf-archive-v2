...
export const ARCHIVE_ROLE = config.ARCHIVE_ROLE;
export const ARCHIVE = config.ARCHIVE;
export const ARCHIVE_ROBOT = config.ARCHIVE_ROBOT;
export const BRREG = config.BRREG;
export const PDF_GENERATOR = config.PDF_GENERATOR;
export const MAIL = config.MAIL;
export const APPREG_CLIENT = config.APPREG_CLIENT;
export const FREG = config.FREG;
export const FINTFOLK = config.FINTFOLK;
export const KRR = config.KRR;
export const ACCESSGROUP_EXCEPTIONS = config.ACCESSGROUP_EXCEPTIONS;
export const GENERATED_PDF_PROPERTY_NAME = config.GENERATED_PDF_PROPERTY_NAME;
export const COUNTY_NUMBER = config.COUNTY_NUMBER;
export const DEV_SYNCEMPLOYEE_MANAGER = config.DEV_SYNCEMPLOYEE_MANAGER;
