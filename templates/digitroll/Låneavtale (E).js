  ...
  archiveTemplate: (archiveData) => {
    return {
      ...
      parameter: {
        ...
        Files: [
          {
            ...
            Format: 'PDF',
            Status: 'F',
            Title: 'Avtale om lån av bærbar PC nettbrett og lån av gratis læremidler (E) - Signert',
        ...
        Status: 'J',
        Title: 'Avtale om lån av bærbar PC/nettbrett og lån av gratis læremidler (E) - Signert',
        UnofficialTitle: `Avtale om lån av bærbar PC/nettbrett og lån av gratis læremidler (E) - Signert - ${archiveData.studentName}`
      }
    }
  },
  requiredFields: {
