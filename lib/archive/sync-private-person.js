...
const {
  MAIL: { toArchiveAdministrator }
} = require("../../config.js");
const callArchiveTemplate = require("../call-archive-template.js");
const callArchive = require("../call-archive.js");
const HTTPError = require("../http-error.js");
const { fregNameBirthdate, fregSsn } = require("../freg.js");
const { handleFakeSsn } = require("../handle-fake-ssn.js");
const { krr } = require("../krr.js");
...
const syncPrivatePerson = async (syncPrivatePersonData, context) => {
  ...
  if (fakeSsn || manualData) {
    ...
    if ([name, streetAddress, zipCode, zipPlace].some((ele) => typeof ele !== "string"))
