...
// biome-ignore lint/suspicious/noExplicitAny: test data assertions cover many possible return shapes
const repacker = (sifResult: Record<string, unknown>, options?: Record<string, unknown>): any => {
...
const resultCreateCase = repacker({
  ErrorDetails: null,
  ErrorMessage: null,
  Recno: 123456,
  CaseNumber: "40/12345",
...
const resultCreateCaseWithWeirdErrorMessage = repacker({
  ErrorDetails: null,
  ErrorMessage: "\n",
  Recno: 123456,
  CaseNumber: "40/12345",
...
const resultCreateCaseWithErrorMessage = repacker({
  ErrorDetails: null,
...
const resultCreateCaseWithErrorMessageFromP360 = repacker({
  ErrorDetails: null,
  ErrorMessage:
...
const resultPrivatePersonWithEmptyResponse = repacker({
  PrivatePersons: [],
  TotalPageCount: 0,
  TotalCount: 0,
  Successful: true,
